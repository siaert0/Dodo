...
<meta name="keywords"
	content="css3, css-only, fullscreen, background, slideshow, images, content" />
<meta name="author" content="Codrops" />
<link rel="shortcut icon" href="../favicon.ico">
<link rel="stylesheet" type="text/css" href="resources/css/demo.css" />
<link rel="stylesheet" type="text/css" href="resources/css/style1.css" />
<script type="text/javascript"
	src="resources/js/modernizr.custom.86080.js"></script>
	...
	<div class="container">
		...
		<div class="codrops-top">
			<a href="http://tympanus.net/Development/RockingLetters/"> <strong>&laquo;
				...
				data-toggle="modal" data-target="#myModal"></a> <a href="#"> <strong>SiteMap</strong>
			</a>
			</span>
			<div class="clr"></div>
		</div>
